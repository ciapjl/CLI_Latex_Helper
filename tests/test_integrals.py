...
class testIntegralParser(unittest.TestCase):
    ...
    def test_simpleIntegral(self):
        ...
        text = "`4x dx` and `1 2` should give integral of 4x dx from 1 to 2"
    ...
    def test_ambiguousVariableOfIntegration(self): 
        ...
        text = "`3` and `45, 67` should give integral of 3 dt from 45 to 67"
    ...
    def test_needVariableOfIntegrationAdded(self):
        ...
        text = "`4a+6a^2+43a^3` and `-2x, 2x+1/2` should give integral of  from -2x to 2x+1/2"
